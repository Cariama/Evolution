                ...
                for i in range(self.Nod) :
                    ...
                    while self.class_in.t < self.class_in.t_day :
                        ...
                        for index,i in enumerate(self.class_in.creatures) :
                            canvas.create_oval( (i.position[0]-0.5)*100*self.scale, (i.position[1]-0.5)*100*self.scale, (i.position[0]+0.5)*100*self.scale, (i.position[1]+0.5)*100*self.scale,fill = my_random_colours[index])
