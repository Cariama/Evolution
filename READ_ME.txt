...
Note : Pour les utilisateur Windows, pour que le graphique soit dynamique, il faut activer l'affichage graphique automatique.
il faut aller dans préférence > console > graphique > sortie graphique et sélectionner automatique.
